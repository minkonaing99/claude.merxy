...
description: Stress-test big decision via structured council of expert perspectives, surface tensions, end with synthesized recommendation + next steps. Use when decision has strategic, financial, operational, reputational, or people stakes and user wants pushback, tradeoffs, many expert viewpoints not quick opinion.
license: MIT
