...
description: Map any system/workflow as interactive HTML diagram. Use when user wants to visualize workflow, map out system, diagram process, or show how something works. Triggers on "visualize this workflow", "map out this system", "diagram my workflow", "show how this works".
license: MIT
